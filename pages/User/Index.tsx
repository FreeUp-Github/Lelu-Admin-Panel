...
export function UserIndex() {
  ...
  useEffect(() => {
    window.parent.postMessage(isOpen ? "open" : "close", "*");
  }, [isOpen]);
  ...
  return (
    <div className=" rounded-lg">
      <div className="sticky top-0 py-2 px-2 flex justify-between bg-white rounded-t-lg">
      ...
      <div className="w-full min-h-[600px] flex flex-col overflow-auto  bg-white">
        {/* <Typography component="h1" variant="h5" fontWeight={700}>
      ...
      <div className="sticky bottom-0 rounded-b-lg p-3 bg-white">
        <form
          onSubmit={(event) => {
